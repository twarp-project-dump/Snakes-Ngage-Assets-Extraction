...
path_to_file = "C:\\Users\\nasty\\Desktop\\game vid\\emulate\\gamersname 2\\data\\drives\\e\\System\\Apps\\6R45_1\\help\\PRERELEASE"

def unpack_speechpack(file_path):
    with open(file_path, 'rb') as f:
        # Read the header (220 bytes)
        ...
        # Extract offsets from the header
        header_entry = {
            "fname_len": 0,
            "fname_off": 0,
            "sound_len": 0,
        ...
        # Extract audio samples (skip the first offset)
